...
export class UpdateUserDto {
  @ApiPropertyOptional({ example: 'Alice', description: 'Prénom de l’utilisateur' })
  @IsOptional()
  @IsString()
  prenom?: string;

  @ApiPropertyOptional({ example: 'Martin', description: 'Nom de l’utilisateur' })
  @IsOptional()
  @IsString()
  nom?: string;

  @ApiPropertyOptional({ example: 'alice.martin@example.com', description: 'Adresse email de l’utilisateur' })
  @IsOptional()
  @IsEmail()
  email?: string;
